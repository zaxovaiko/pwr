...
bool CMscnProblem::bSetValueCD(int iRow, int iColumn, double dVal) {
...
bool CMscnProblem::bSetValueCF(int iRow, int iColumn, double dVal) {
...
bool CMscnProblem::bSetValueCM(int iRow, int iColumn, double dVal) {
...
bool CMscnProblem::bSetValueSD(int iIndex, double dVal) {
...
bool CMscnProblem::bSetValueSF(int iIndex, double dVal) {
...
bool CMscnProblem::bSetValueSM(int iIndex, double dVal) {
...
bool CMscnProblem::bSetValueSS(int iIndex, double dVal) {
...
bool CMscnProblem::bSetValueUD(int iIndex, double dVal) {
	if (iIndex < 0 || iIndex >= i_D) {
		return false;
	}
	pd_ud[iIndex] = dVal;
...
bool CMscnProblem::bSetValueUF(int iIndex, double dVal) {
	if (iIndex < 0 || iIndex >= i_F) {
		return false;
	}
	pd_uf[iIndex] = dVal;
...
bool CMscnProblem::bSetValueUM(int iIndex, double dVal) {
	if (iIndex < 0 || iIndex >= i_M) {
		return false;
	}
	pd_um[iIndex] = dVal;
...
bool CMscnProblem::bSetValueP(int iIndex, double dVal) {
	if (iIndex < 0 || iIndex >= i_S) {
		return false;
	}
	pd_p[iIndex] = dVal;
...
bool CMscnProblem::bSetValueXDMinMax(int iRow, int iColumn, double dVal) {
...
bool CMscnProblem::bSetValueXFMinMax(int iRow, int iColumn, double dVal) {
...
bool CMscnProblem::bSetValueXMMinMax(int iRow, int iColumn, double dVal) {
...
bool CMscnProblem::bRead(string sFileName) {
	...
	for (int i = 0; i < 2 * i_D; i += 2) {
		for (int j = 0; j < i_F; j++) {
			file >> d_num >> q;
			bSetValueXDMinMax(i, j, d_num);
			cout << "xdminmax[" << i << ", " << j << "]: " << ppd_xdminmax[i][j] << "\n";
			file >> d_num >> q;
			bSetValueXDMinMax(i + 1, j, d_num);
	...
	for (int i = 0; i < 2 * i_F; i += 2) {
		for (int j = 0; j < i_M; j++) {
			file >> d_num >> q;
			bSetValueXFMinMax(i, j, d_num);
			cout << "xfminmax[" << i << ", " << j << "]: " << ppd_xfminmax[i][j] << "\n";
			file >> d_num >> q;
			bSetValueXFMinMax(i + 1, j, d_num);
	...
	for (int i = 0; i < 2 * i_M; i += 2) {
		for (int j = 0; j < i_S; j++) {
			file >> d_num >> q;
			bSetValueXMMinMax(i, j, d_num);
			cout << "xmminmax[" << i << ", " << j << "]: " << ppd_xmminmax[i][j] << "\n";
			file >> d_num >> q;
			bSetValueXMMinMax(i + 1, j, d_num);
